...
import ni.org.ics.solicitudes.language.DatabaseDrivenMessageSource;
 ...
 */
@Controller
@RequestMapping("/super/traduccion/*")
public class SuperTraduccionController {
	private static final Logger logger = LoggerFactory.getLogger(SuperTraduccionController.class);
