  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<spring:url value="/admin/estudios/" htmlEscape="true "/>"><spring:message code="studies" /></a></li>
        <li class="breadcrumb-item active"><c:out value="${estudio.nombreEstudio}" /></li>
        <!-- Breadcrumb Menu-->
	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header bg-dark text-white">
	                  <i class="fa fa-archive"></i>&nbsp;<strong><c:out value="${estudio.nombreEstudio}" /></strong>
	                </div>
                	<div class="card-body">
	                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
	                		<div class="form-group row">
		                      <label class="col-md-3 col-form-label"><spring:message code="idEstudio" />:</label>
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${estudio.idEstudio}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-3 col-form-label"><spring:message code="codEstudio" />:</label>
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${estudio.codEstudio}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                    ...
		                    <div class="form-group row">
		                      ...
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${estudio.recordUser}" /></strong></p>
		                      </div>
		                    </div>
		                    <div class="form-group row">
		                      <label class="col-md-3 col-form-label"><spring:message code="dateCreated" />:</label>
		                      <div class="col-md-9">
		                        <p class="form-control-static"><strong><c:out value="${estudio.recordDate}" /></strong></p>
		                      </div>
		                    </div>
	                	</form>
					</div>
