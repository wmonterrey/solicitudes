  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="sols.aprob" /></li>
        <!-- Breadcrumb Menu-->
      ...
      <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <i class="icon-check"></i> <spring:message code="sols.aprob" />
              ...
              <table id="lista_solicitudes" class="table table-striped table-bordered datatable" width="100%">
                ...
                <tbody>
                	<c:forEach items="${solicitudes}" var="solicitud">
                		<tr>
                			<spring:url value="/sols/aprobar/{idSolicitud}/"  var="aprobarSolUrl">
							...
							<td><a href="${fn:escapeXml(aprobarSolUrl)}" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i></a></td>
                		</tr>
                	</c:forEach>
                </tbody>
              </table>
