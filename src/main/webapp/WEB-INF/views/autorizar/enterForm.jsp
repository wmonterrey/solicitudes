...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <!-- Main content -->
    <main class="main">
	  <spring:url value="/sols/autorizar/autorizarItem/" var="autorizarItemUrl"></spring:url>
  	  <spring:url value="/sols/autorizar/{idSolicitud}/" var="solicitudUrl">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="icon-note"></i> <spring:message code="authorize" /> <spring:message code="itemcat" />
                    ...
                    <div class="col-md-8">
                      <form action="#" autocomplete="off" id="add-item-form">   
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-10">
	                      	<input id="cantAprobada" class="form-control" readonly value="${item.cantAprobada}"/>
		                ...
		                <div class="form-group row">
	                      <label class="col-md-2 col-form-label"><spring:message code="cantAutorizada" />:</label>
	                      <div class="col-md-10">
	                      	<div class="input-group">
	                      		<span class="input-group-addon"><i class="fa fa-sort-numeric-asc"></i></span>
	                        	<input type="text" id="cantAutorizada" name="cantAutorizada" autocomplete="cantAutorizada" value="${item.cantAutorizada}" class="form-control" placeholder="<spring:message code="cantAutorizada" />">
	                        </div>
	                      </div>
	                    </div>
...
<script>
	jQuery(document).ready(function() {
		var parametros = {saveItemUrl: "${autorizarItemUrl}", successmessage: "${successmessage}",
