  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="sols.aut" /></li>
        <!-- Breadcrumb Menu-->
      ...
      <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <i class="icon-key"></i> <spring:message code="sols.aut" />
              ...
              <table id="lista_solicitudes" class="table table-striped table-bordered datatable" width="100%">
                ...
                <tbody>
                	<c:forEach items="${solicitudes}" var="solicitud">
                		<tr>
                			<spring:url value="/sols/autorizar/{idSolicitud}/"  var="autorizarSolUrl">
							...
							<td><a href="${fn:escapeXml(autorizarSolUrl)}" class="btn btn-outline-primary btn-sm"><i class="fa fa-edit"></i></a></td>
                		</tr>
                	</c:forEach>
                </tbody>
              </table>
