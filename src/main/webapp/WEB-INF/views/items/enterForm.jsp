...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <!-- Main content -->
    <main class="main">
	  <spring:url value="/sols/items/saveItem/" var="saveItemUrl"></spring:url>
  	  <spring:url value="/sols/{idSolicitud}/" var="solicitudUrl">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <form action="#" autocomplete="off" id="add-item-form">   
	                    ...
	                    <div class="form-group row">
	                      <label class="col-md-2 col-form-label"><spring:message code="usrSolicitaItem" />:</label>
	                      <div class="col-md-10">
	                      	<div>
		                        <select name="usrSolicitaItem" id="usrSolicitaItem" class="form-control select2-single">
			                    	<option value=""><spring:message code="empty"/></option>
			                    	<c:forEach items="${usuarios}" var="usuario">
										<c:choose> 
											<c:when test="${usuario.user.username eq item.usrSolicitaItem}">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-10">
	                      	<div>
		                        <select name="insumo" id="insumo" class="form-control select2-single">
			                    	<option value=""><spring:message code="empty"/></option>
			                    	<c:choose>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-10">
	                      	<div class="input-group">
	                        	...
	                        	<input type="text" id="cantSolicitada" name="cantSolicitada" autocomplete="cantSolicitada" value="${item.cantSolicitada}" class="form-control" placeholder="<spring:message code="cantSolicitada" />">
	                        </div>
	                      </div>
	                    </div>
...
<script>
	jQuery(document).ready(function() {
		var parametros = {saveItemUrl: "${saveItemUrl}", successmessage: "${successmessage}",
