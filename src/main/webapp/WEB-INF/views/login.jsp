...
<body class="app flex-row align-items-center">
          ...
          <div class="card p-4">
            ...
            <form class="login-form" action="j_spring_security_check" method="post">
	            ...
	            <div class="input-group mb-4">
	         	...
	         	<div class="row">
	                <div class="col-6">
	                    <button type="submit" class="btn btn-dark text-white px-2" style="width:100%"><spring:message code="login"/></button>
	                </div>
  ...
  <script>
	$(".actEng").click(function(){ 
		...
		document.cookie="eSolicitudesLang=en;"+expires+"; path=/solicitudes/";
		location.reload();
        });
	...
	$(".actEsp").click(function(){ 
		...
		d.setTime(d.getTime() + (365*24*60*60*1000));
	    var expires = "expires="+d.toUTCString();
		document.cookie="eSolicitudesLang=es;"+expires+"; path=/solicitudes/";
		location.reload();
        });
