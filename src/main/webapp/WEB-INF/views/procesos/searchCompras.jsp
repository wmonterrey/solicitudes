...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="process.shop" /></li>
        <!-- Breadcrumb Menu-->
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="icon-basket-loaded"></i> <spring:message code="process.shop" />
                  <div class="card-actions">
                  </div>
                </div>
                <div class="card-body">
                  <spring:url value="/procesos/compras/addCompra/"	var="newCompra"/>	
              	  <button id="lista_compras_new" onclick="location.href='${fn:escapeXml(newCompra)}'" type="button" class="btn btn-outline-primary"><i class="fa fa-plus"></i>&nbsp; <spring:message code="add" /></button><br><br>
                  <div class="row">
                  	<div class="col-md-10">
	                  	<form action="#" autocomplete="off" id="compras-form">
		                  	<div class="form-group row">
		                      <div class="input-group">
		                        <span class="input-group-addon"><input type="checkbox" id="checkNumero" name="checkNumero" value=""></span>
		                        <input type="text" id="numFactura" name="numFactura" disabled class="form-control" placeholder="<spring:message code="numFactura" />">
		                      </div>
		                    </div>
	           			  <div class="form-group row">
			                  <label><spring:message code="fechaCompra" /></label>
			                  <div class="input-group">
		                  ...
		                  <div class="form-group row">
			                  <div class="col-md-3">
			                    <label><spring:message code="lugarCompra" /></label>
			                    <select id="lugarCompra" name="lugarCompra" class="form-control select2-single">
			                  ...
			                  <div class="col-sm-3">
			                    <label><spring:message code="proveedor" /></label>
			                    <select id="proveedor" name="proveedor" class="form-control select2-single">
			                    	<option value="ALL"><spring:message code="all"/></option>
			                  ...
			                  <div class="col-sm-3">
			                    <label><spring:message code="cuenta" /></label>
			                    <select id="cuenta" name="cuenta" class="form-control select2-single">
			                    	<option value="ALL"><spring:message code="all"/></option>
		                  ...
		                  <div class="row float-right mr-4" >  
		                    	<button type="submit" class="btn btn-primary" id="buscarcompras""><i class="fa fa-check"></i>&nbsp;<spring:message code="search" /></button>
				          </div>
	                  	</form>
                  	</div>
                  </div>
		              ...
		              <table id="resultados" class="table table-striped table-bordered datatable" width="100%">
		                <thead>
		                	<tr>
			                    ...
			                    <th><spring:message code="lugarCompra" /></th>
			                    <th><spring:message code="fechaCompra" /></th>
			                    <th><spring:message code="proveedor" /></th>
			                    <th><spring:message code="numFactura" /></th>
  ...
  <spring:url value="/procesos/compras/" var="comprasUrl"/>
  
  <!-- Custom scripts required by this view -->
  <spring:url value="/resources/js/views/BuscarCompras.js" var="processSearch" />
  <script src="${processSearch}"></script>
  
  <script>
  	jQuery(document).ready(function() {
		var parametros = {comprasUrl: "${comprasUrl}",successmessage: "${successmessage}",
