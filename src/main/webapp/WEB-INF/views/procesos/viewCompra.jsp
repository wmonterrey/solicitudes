...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><c:out value="${compra.idCompra}" /></li>
        <!-- Breadcrumb Menu-->
      ...
      <spring:url value="/procesos/compras/editCompra/{idCompra}/" var="editUrl">
		<spring:param name="idCompra" value="${compra.idCompra}" />
	  </spring:url>
	  
	  <spring:url value="/procesos/compras/desCompra/{idCompra}/" var="disableUrl">
		<spring:param name="idCompra" value="${compra.idCompra}" />
	  </spring:url>
	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <i class="icon-basket-loaded"></i>&nbsp;<spring:message code="item" />:&nbsp;<strong><c:out value="${compra.item.codigoBrand}" /></strong>
	                  <c:if test = "${esactiva}">
	                  <ul class="nav nav-tabs float-right">
						  <li class="nav-item dropdown">
						    ...
						    <div class="dropdown-menu">						    	
						    	...
						    	<a href="#" class="dropdown-item desact" data-nomitem="${compra.idCompra}" data-toggle="modal" data-whatever="${fn:escapeXml(disableUrl)}"><i class="fa fa-trash-o"></i> <spring:message code="delete" /></a>
						    </div>
						  </li>
						</ul>
						</c:if>
	                	...
	                	<div class="card-body">
		                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		                		<div class="form-group row">
			                      ...
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.idCompra}" /></strong></p>
			                      </div>
			                      <label class="col-md-2 col-form-label"><spring:message code="fechaCompra" />:</label>
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.fechaCompra}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-10">
									...
									<c:when test="${cookie.eSolicitudesLang.value == 'en'}">
										<p class="form-control-static"><strong><c:out value="${compra.item.nombreInsumoEn}" /></strong></p>
									</c:when>
									<c:otherwise>
										<p class="form-control-static"><strong><c:out value="${compra.item.nombreInsumoEs}" /></strong></p>
									</c:otherwise>
							  		</c:choose>
			                      </div>
			                    </div>
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.lugarCompra}" /></strong></p>
			                      </div>
			                      <label class="col-md-2 col-form-label"><spring:message code="cuenta" />:</label>
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.cuenta.nombreCuenta}" /></strong></p>
			                      </div>
			                    </div>
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.proveedor}" /></strong></p>
			                      </div>
			                      <label class="col-md-2 col-form-label"><spring:message code="numFactura" />:</label>
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.numFactura}" /></strong></p>
			                      </div>
			                    </div>
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.cantComprada}" /></strong></p>
			                      </div>
			                      <label class="col-md-2 col-form-label"><spring:message code="presentacion" />:</label>
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.presentacion}" /></strong></p>
			                      </div>
			                    </div>
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.contenidoPresentacion}" /></strong></p>
			                      </div>
			                      <label class="col-md-2 col-form-label"><spring:message code="totalProducto" />:</label>
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.totalProducto}" /></strong></p>
			                      </div>
			                    </div>
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.observaciones}" /></strong></p>
			                      </div>
			                      <label class="col-md-2 col-form-label"><spring:message code="motivoCancelada" />:</label>
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.motivoCancelada}" /></strong></p>
			                      </div>
			                    </div>
			                    ...
			                    <div class="form-group row">
			                      ...
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.recordUser}" /></strong></p>
			                      </div>
			                      <label class="col-md-2 col-form-label"><spring:message code="dateCreated" />:</label>
			                      <div class="col-md-4">
			                        <p class="form-control-static"><strong><c:out value="${compra.recordDate}" /></strong></p>
			                      </div>
			                    </div>
		                	</form>
						</div>
  ...
  <!-- Lenguaje -->
  <c:choose>
	<c:when test="${cookie.eCompraesLang.value == null}">
		<c:set var="lenguaje" value="es"/>
	</c:when>
	<c:otherwise>
		<c:set var="lenguaje" value="${cookie.eCompraesLang.value}"/>
	</c:otherwise>
  </c:choose>
  ...
  <c:set var="compraDisabledLabel"><spring:message code="compraDisabled" /></c:set>
  ...
  <script>
	...
	if ("${compraDeshabilitada}"){
		toastr.error("${compraDisabledLabel}", "${nombreCompra}" , {
		    closeButton: true,
		    progressBar: true,
		  });
	}
