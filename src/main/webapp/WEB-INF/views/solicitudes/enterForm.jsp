...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <!-- Main content -->
    <main class="main">
	  <spring:url value="/sols/saveSolicitud/" var="saveSolicitudUrl"></spring:url>
  	  <spring:url value="/sols/" var="solicitudesUrl"/>	
  	  <spring:url value="/sols/{idSolicitud}/" var="undoUrl">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="icon-note"></i> <spring:message code="sols" />
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <form action="#" autocomplete="off" id="add-solicitud-form">   
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-10">
	                      	<div class="input-group">
	                      		<span class="input-group-addon"><i class="fa fa-key"></i></span>
	                        	<input type="text" id="numSolicitud" name="numSolicitud" readonly autocomplete="numSolicitud" value="${solicitud.numSolicitud}" class="form-control" placeholder="<spring:message code="numSolicitud" />">
	                        </div>
	                      </div>
	                    </div>
	                    
	                    <div class="form-group row">
	                      <fmt:formatDate value="${solicitud.fecSolicitud}" var="datesolicitud" pattern="dd/MM/yyyy" />
	                      <label class="col-md-2 col-form-label"><spring:message code="fecSolicitud" />:</label>
	                      <div class="col-md-10">
	                      	<div class="input-group">
	                      		<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
	                        	<input type="text" id="fecSolicitud" name="fecSolicitud" value="${datesolicitud}" class="form-control date-picker" data-date-format="dd/mm/yyyy" data-date-end-date="+0d" placeholder="<spring:message code="fecSolicitud" />">
	                        </div>
	                      </div>
	                    </div>
	                    
	                    <div class="form-group row">
	                      <fmt:formatDate value="${solicitud.fecRequerida}" var="daterequerida" pattern="dd/MM/yyyy" />
	                      <label class="col-md-2 col-form-label"><spring:message code="fecRequerida" />:</label>
	                      <div class="col-md-10">
	                      	<div class="input-group">
	                      		<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
	                        	<input type="text" id="fecRequerida" name="fecRequerida" value="${daterequerida}" class="form-control date-picker" data-date-format="dd/mm/yyyy" data-date-start-date="+0d" placeholder="<spring:message code="fecRequerida" />">
	                        </div>
	                      </div>
	                    </div>
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-10">
	                      	<div>
		                        <select name="ctrSolicitud" id="ctrSolicitud" class="form-control select2-single">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-10">
	                      	<div>
		                        <select name="tipoSolicitud" id="tipoSolicitud" class="form-control select2-single">
			                    	<option value=""><spring:message code="empty"/></option>
			                    	<c:forEach items="${tipos}" var="tipo">
										<c:choose> 
											<c:when test="${tipo.catKey eq solicitud.tipoSolicitud}">
	                    ...
	                    <div class="form-group row">
	                      ...
	                      <div class="col-md-10">
	                      	<div class="input-group">
	                        	...
	                        	<input type="text" id="observaciones" name="observaciones" autocomplete="observaciones" value="${solicitud.observaciones}" class="form-control" placeholder="<spring:message code="observaciones" />">
	                        </div>
	                      </div>
	                    </div> 
                        ...
                        <div class="form-group">
                          ...
                          <c:choose> 
							<c:when test="${empty solicitud.idSolicitud}">
								<a href="${fn:escapeXml(solicitudesUrl)}" class="btn btn-danger"><i class="fa fa-undo"></i>&nbsp;<spring:message code="cancel" /></a>
							</c:when>
							<c:otherwise>
  ...
  <spring:url value="/resources/js/views/Solicitudes.js" var="processSolicitud" />
  <script src="${processSolicitud}"></script>
...
<script>
	jQuery(document).ready(function() {
		var parametros = {saveSolicitudUrl: "${saveSolicitudUrl}", successmessage: "${successmessage}",
				errormessage: "${errormessage}",waitmessage: "${waitmessage}",
				solicitudesUrl: "${solicitudesUrl}" 
		};
		ProcessSolicitud.init(parametros);
	});
</script>
