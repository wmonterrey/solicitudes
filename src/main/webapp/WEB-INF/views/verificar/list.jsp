...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  ...
  <div class="app-body">
    ...
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><spring:message code="sols.verif" /></li>
        <!-- Breadcrumb Menu-->
      ...
      <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <i class="icon-like"></i> <spring:message code="sols.verif" />
              ...
              <table id="lista_entregas" class="table table-striped table-bordered datatable" width="100%">
                ...
                <tbody>
                	<c:forEach items="${itemsEntregar}" var="entrega">
						<tr>
							<spring:url value="/sols/verificar/{idEntrega}/" var="entregaItemUrl">
                            ...
                            <fmt:formatDate value="${entrega.fechaEntrega}" var="dateentrega" pattern="yyyy-MM-dd" />
                            <td><c:out value="${datesolicitud}" /></td>
                            <td><c:out value="${dateentrega}" /></td>
							...
							<td>	
								<a href="#" data-toggle="modal" data-whatever="${fn:escapeXml(entregaItemUrl)}" class="btn btn-outline-primary btn-sm verificar"><i class="icon-like"></i></a>
							</td>
						</tr>
					</c:forEach>
                </tbody>
  ...
  <c:set var="verif"><spring:message code="sols.verif" /></c:set>
